...
#====== select dataset ======#
path_data_root="/home/fontana/Pre_extracted_features/RGB/ek_tsm" # depend on users
path_labels_root="/home/fontana/labels" #"/jmain01/home/JAD026/dxd01/jjm50-dxd01/DA_Features/train_test/train/" # depend on users
...
then
	...
	lr_decay=10
    	lr_adaptive=dann # dann # none | loss | dann -> It needs dann
    	lr_steps_1=10
    	lr_steps_2=20
    	epochs=30
	gd=20
	...
	--afn_DA $afn_DA --weight_afn $weight_afn --radius_hafn $radius_hafn --radius_safn $radius_safn
