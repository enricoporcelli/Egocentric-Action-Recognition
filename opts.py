...
parser.add_argument('train_source_list', type=str, default="/home/fontana/labels/D1_test.pkl")
...
parser.add_argument('--afn_DA', type=str, default='none', choices=['none', 'HAFN', 'SAFN'],
                   help='adaptive feature norm')
...
parser.add_argument('--weight_afn', type=float, default=0.01, help='weight for the hafn')
parser.add_argument('--radius_hafn', type=float, default=1, help='Radius to be taken into account for the hafn')
parser.add_argument('--radius_safn', type=float, default=0.3, help='radius update for the safn')
